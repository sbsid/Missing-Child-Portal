...
echo "<tr><td><img src=images/$row[img] class='rounded-circle' alt='$row[img]'></td>
    ...
    <td>$row[dates]</td>
    <td>$row[post]</td>
    <td> <a href='http://localhost/php/edit.php?da=$row[dates]&na=$row[name]&age=$row[age]&po=$row[post]&ig=$row[img]'> EDIT </td>
    <td> <a href='http://localhost/php/delete.php?da=$row[dates]'> Delete </td>
</tr>";
  }
echo "</table>";
}else{
